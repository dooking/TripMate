...
<img src="./img/main.png" alt="main" style="width:400px;" />
...
#### (2) 채팅방
여행지명과 채팅 상대방의 이름이 상단에 표기되며, 보내는 채팅은 오른쪽에 받는 채팅은 왼쪽에 정렬된다. 뒤로 가기 버튼을 누르면 채팅 리스트 페이지로 돌아간다.<img src="./img/chat.png" alt="chat" style="width:80%;" />
